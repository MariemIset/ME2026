"""Shared synthetic-data fixtures for BO2 unit tests."""
...
def synthetic_customers() -> pd.DataFrame:
    ...
    df = pd.DataFrame({
        ...
        "loyalty_card": rng.choice(["Star", "Nova", "Aurora"], size=n, p=[0.5, 0.3, 0.2]),
        ...
        "enrollment_type": rng.choice(["Standard", "2018 Promotion"], size=n, p=[0.8, 0.2]),
    })
